...
# install kernel
wget https://github.com/feryw/msm8916-kernel/releases/download/v6.12.46-wyref-gcc10-armv7/linux-image-6.12.46-wyref_6.12.46-gc28eac9f1803-2_armhf.deb -O linux-image.deb
...
ln -sf ${CHROOT}/boot/vmlinuz-6.12.46-wyref ${CHROOT}/boot/vmlinuz
ln -sf ${CHROOT}/boot/System.map-6.12.46-wyref ${CHROOT}/boot/System.map
